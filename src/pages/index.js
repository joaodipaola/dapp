            ...
            !wallet
              ? (
                <div className='col-10 col-sm-8 col-lg-6'>
                  <img src='https://images.unsplash.com/photo-1520694478166-daaaaec95b69?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fHBlc3NvYXMlMjBmZWxpemVzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60' className='d-block mx-lg-auto img-fluid' width='700' height='500' />
                </div>
              )
            : (
              <div className='col-10 col-sm-8 col-lg-6'>
